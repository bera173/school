...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2024 at 12:47 AM
...
-- Database: `knjizara`
--
CREATE DATABASE IF NOT EXISTS `knjizara` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `knjizara`;
...
--
CREATE DATABASE IF NOT EXISTS `maticna_knjiga_ucenika` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `maticna_knjiga_ucenika`;
...
CREATE TABLE `direction` (
  `id` int(11) NOT NULL,
  `direction_name` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `grades`
  ...
  ADD CONSTRAINT `grades_ibfk_3` FOREIGN KEY (`id_school_year`) REFERENCES `school_year` (`id`);

--
-- Constraints for table `school_class`
--
ALTER TABLE `school_class`
  ADD CONSTRAINT `school_class_ibfk_1` FOREIGN KEY (`id_school_year`) REFERENCES `school_year` (`id`);

--
-- Constraints for table `students`
--
ALTER TABLE `students`
  ADD CONSTRAINT `students_ibfk_1` FOREIGN KEY (`id_class`) REFERENCES `school_class` (`id`);
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"maticna_knjiga_ucenika\",\"table\":\"users\"},{\"db\":\"maticna_knjiga_ucenika\",\"table\":\"grades\"},{\"db\":\"maticna_knjiga_ucenika\",\"table\":\"students\"},{\"db\":\"maticna_knjiga_ucenika\",\"table\":\"school_class\"},{\"db\":\"maticna_knjiga_ucenika\",\"table\":\"direction\"},{\"db\":\"maticna_knjiga_ucenika\",\"table\":\"subjects\"},{\"db\":\"maticna_knjiga_ucenika\",\"table\":\"school_year\"},{\"db\":\"maticna_knjiga_ucenika\",\"table\":\"predmeti\"}]');
...
('maticna_knjiga_ucenika', 'school_class', 'class'),
('maticna_knjiga_ucenika', 'students', 'name');
...
('root', '2024-03-27 23:41:41', '{\"Console\\/Mode\":\"collapse\"}');
